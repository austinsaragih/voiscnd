# -*- coding: utf-8 -*-
"""
VOI Evaluator - 5x3 Grid - Single Run 1 of 3 (seed_offset=0)
...
# =============================================================================
# 5. SINGLE RUN - EXACT MONOLITHIC ONLY (Run 2 of 3, seed_offset=10)
# =============================================================================
seed_offset = 10  # Run 2
print(f"\n==================== EXACT RUN 2/3 (seed_offset={seed_offset}) ====================")

# --- H. Exact Monolithic ---
print(f"[Exact Run 2] Running Exact Monolithic Evaluation...")
...
# =============================================================================
print("\n" + "="*80)
print(f"RESULTS | Exact Run 2/3 (seed_offset={seed_offset}) | Setup: {ACTIVE_SETUP} | Nodes: {len(G_nodes)}")
