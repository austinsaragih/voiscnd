...
# =============================================================================
# 5. SINGLE RUN (Run 1 of 3, seed_offset=0)
# =============================================================================
seed_offset = 0  # Run 1
print(f"\n==================== RUN 1/3 (seed_offset={seed_offset}) ====================")

results = {}

print(f"[Run 1] Running RP Evaluation...")
st = timeit.default_timer()
RP_val = SAA_ETSCI([], seed_offset)
results['No Information (RP)'] = {'val': RP_val, 'time': timeit.default_timer() - st}

print(f"[Run 1] Running WS Evaluation...")
st = timeit.default_timer()
...
# --- C. Greedy EVPPI/Cost ---
print(f"[Run 1] Running Greedy EVPPI/Cost...")
st = timeit.default_timer()
...
print(f"[Run 1] Running Greedy Variance/Cost...")
st = timeit.default_timer()
...
# --- E. Top-5 EVPPI ---
print(f"[Run 1] Running Top-5 EVPPI...")
st = timeit.default_timer()
EVPPI_i = {i: RP_val - (SAA_ETSCI([i], seed_offset) - CGI([i])) for i in G_nodes}
...
# --- F. Bounds (Proposed) ---
print(f"[Run 1] Running Bounds Approximation...")
st = timeit.default_timer()
EVPPI_i = {i: RP_val - (SAA_ETSCI([i], seed_offset) - CGI([i])) for i in G_nodes}
...
# --- G. APSM (Proposed) ---
print(f"[Run 1] Running APSM Algorithm...")
st = timeit.default_timer()
...
# =============================================================================
print("\n" + "="*80)
print(f"RESULTS | Run 1/3 (seed_offset={seed_offset}) | Setup: {ACTIVE_SETUP} | Nodes: {len(G_nodes)}")
