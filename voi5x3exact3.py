...
# =============================================================================
# 5. SINGLE RUN - EXACT MONOLITHIC ONLY (Run 3 of 3, seed_offset=20)
# =============================================================================
seed_offset = 20  # Run 3
print(f"\n==================== EXACT RUN 3/3 (seed_offset={seed_offset}) ====================")

# --- H. Exact Monolithic ---
print(f"[Exact Run 3] Running Exact Monolithic Evaluation...")
...
# =============================================================================
print("\n" + "="*80)
print(f"RESULTS | Exact Run 3/3 (seed_offset={seed_offset}) | Setup: {ACTIVE_SETUP} | Nodes: {len(G_nodes)}")
